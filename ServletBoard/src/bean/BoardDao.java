...
public class BoardDao {
   ...
   String uploadPath = "E:/workspace/ServletBoard/WebContent/upload/";
   ...
   ResultSet rs = null;
	...
	public BoardDao() {
	   try{
   		...
   		int cnt=0;
   		String sql = "";
   		//테이블 및 시퀀스가 존재하지 않으면 자동 생성
   		sql = "select count(*) cnt from user_tables where table_name = upper('board111')";
   		...
   		if(cnt <1){
   		   ...
   		   sql = "create sequence seq_board111";
   		   ps = conn.prepareStatement(sql);
   		   ps.execute();
   		}
