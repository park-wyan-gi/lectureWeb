...
<body>
	...
	<form name='frm' method='post' action='member_input_result.jsp'>
		...
		<label>아이디</label> <input type='text' name='mid' value='a001'
			...
			type='text' name='irum' value='원기'><br /> <label>암호</label>
		<input type='text' name='pwd' value='1111' size='10'><br /> <label>암호확인</label>
		<input type='text' name='pwd2' value='1111' size='10'><br />
		<label>성별</label> <label><input type='radio' name='gender'
			value='m'>남자</label> <label><input type='radio' name='gender'
			value='f'>여자</label><br /> <label>연락처</label> <select name='ph1'>
